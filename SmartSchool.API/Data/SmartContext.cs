...
namespace SmartSchool.API.Data
{
    public class SmartContext : DbContext
    {
        ...
        public SmartContext(DbContextOptions<SmartContext> dbContextOptions) : base(dbContextOptions)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Student>()
                .HasData(new List<Student>(){
                    new Student(1, 1, "Marta", "Kent", "33225555", DateTime.Parse("05/05/2005")),
                    new Student(2, 2, "Paula", "Isabela", "3354058", DateTime.Parse("05/05/2005")),
                    new Student(3, 3, "Laura", "Antonia", "55668899", DateTime.Parse("05/05/2005")),
                    new Student(4, 4, "Luiza", "Maria", "6565659", DateTime.Parse("05/05/2005")),
                    new Student(5, 5, "Lucas", "Machado", "565685415", DateTime.Parse("05/05/2005")),
                    new Student(6, 6, "Pedro", "Alvares", "456454545", DateTime.Parse("05/05/2005")),
                    new Student(7, 7, "Paulo", "José", "9874512", DateTime.Parse("05/05/2005"))
                });
